...
const NormLogo = () => {
  return (
    <svg
      version="1.1"
      id="Layer_2_00000057855435303224187750000009686052281420832165_"
      xmlns="http://www.w3.org/2000/svg"
      x="0px"
      y="0px"
      viewBox="0 0 481 96.3"
    >
      <style type="text/css"></style>
      <path
        className="st0"
        d="M6.7,96.3V24.7L0,20.6V8.8l23.8-6.5h18.8v14.3l1.3-1.7c0.9-1.2,2.2-2.6,3.9-4.2c1.7-1.6,3.7-3.2,5.8-4.8
	...
	s-0.7,0.6-0.8,0.7v64.6L6.7,96.3L6.7,96.3z"
      ...
      <path
        fill=""
        className="st0 "
        d="M263.2,96.3V24.7l-6.6-4.1V8.1l23.8-5.9h9l3.2,26.4c3-18.1,12.7-27.1,29.1-27.1c1.8,0,3.8,0.3,5.8,1l-3.8,39.4
	c-1.5-1.4-5-2.1-10.2-2.1c-7.5,0-12.4,2-14.5,6v50.6L263.2,96.3L263.2,96.3L263.2,96.3z"
      />
      <path
        className="st0"
        d="M336,96.3V24.7l-6.6-4.1V8.8l23.8-6.5H372v14.3c0.4-0.5,0.9-1.2,1.6-2.1c0.7-0.9,2-2.2,3.9-4
	...
	s-0.7,0.6-0.8,0.7v64.6H336L336,96.3L336,96.3z"
      ...
      <path
        className="st0"
        d="M224.6,1.4h-92.1c-15,0-27.1,12.1-27.1,27.1v40.7c0,15,12.1,27.1,27.1,27.1h92.1c15,0,27.1-12.1,27.1-27.1V28.5
